...
public class EditEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainMenu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditEventActivity.this , MainMenu.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
            }
        });
        ...
        }, EditEventActivity.this, new BasicAdapter.onLongItemClickListener() {
            @Override
    ...
    public void showTimePickerDialog(View v) {
        DialogFragment newFragment = new EditEventActivity.TimePickerFragment().newInstance(new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void showDatePickerDialog(View v) {
        DialogFragment newFragment1 = new EditEventActivity.DatePickerFragment().newInstance(new DatePickerDialog.OnDateSetListener(){
            @Override
    ...
    private void get_event(Integer id){
        AppCustomService service = RetrofitClient.getClient();
        Call<Event> eventCall = service.get_event(getTokenType()+" "+getToken(),id);
        eventCall.enqueue(new Callback<Event>() {
            ...
            public void onFailure(Call<Event> call, Throwable t) {
                Toast.makeText(EditEventActivity.this, "Error de conexión" , Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void save_event() {
        AppCustomService service = RetrofitClient.getClient();
        Call<ResponseBody> responseBodyCall = service.update_event(getTokenType()+" "+getToken(),id,
                new Event(
        ...
        responseBodyCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if(response.isSuccessful())
                {
                    Toast.makeText(EditEventActivity.this, "El evento se guardo exitosamente" , Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(EditEventActivity.this , EventsActivity.class);
                    startActivity(intent);
                }
            }
        ...
        switch (item.getItemId()) {
            case R.id.log_out: {
                ...
                responseBodyCall.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        if(response.isSuccessful()) {
                            Toast.makeText(EditEventActivity.this, "Cerrando sessión" , Toast.LENGTH_SHORT).show();
                    ...
                    @Override
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        Toast.makeText(EditEventActivity.this, "No se pudo conectar con el servidor, revise su conexión", Toast.LENGTH_LONG).show();
                    }
                });
                return true;
            }
    ...
    public void setValues() {
        dateEvent.setText(event.getEvent_info().getDate());
        timeDate.setText(event.getEvent_info().getHour());
        nameEditText.setText(event.getEvent_info().getCustomer_name());
        addressEditText.setText(event.getEvent_info().getAddress());
        phoneEditText.setText(event.getEvent_info().getPhone());
        advance_payment.setText(event.getEvent_info().getAdvance_payment().toString());
        basicAdapter.updateList(event.getEvent_info().getBasic_package());
        othersAdapter.updateList(event.getEvent_info().getExtras_list());
        updateTotal();
    }
    ...
    public static class TimePickerFragment extends DialogFragment {
        ...
        public static EditEventActivity.TimePickerFragment newInstance(TimePickerDialog.OnTimeSetListener listener){
            EditEventActivity.TimePickerFragment fragment  = new EditEventActivity.TimePickerFragment();
    ...
    public static class DatePickerFragment extends DialogFragment {
        ...
        public static EditEventActivity.DatePickerFragment newInstance(DatePickerDialog.OnDateSetListener listener){
            EditEventActivity.DatePickerFragment fragment = new EditEventActivity.DatePickerFragment();
            fragment.setListener(listener);
            return fragment;
        }
